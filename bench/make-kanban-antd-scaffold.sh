#!/bin/bash
# Creates a fresh, empty bench/<name> scaffold for the Kanban benchmark's antd condition —
# no rebar-ui dependency at all, since this condition is the hand-rolled-antd comparison point.
# Usage: ./make-kanban-antd-scaffold.sh kanban-antd-01
set -e
NAME="$1"
