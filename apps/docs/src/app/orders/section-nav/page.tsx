...
// same real-world scale as /docs/heuristics' 46 real entries, the page this behavior was built for.
...
const BLOCKS: Block[] = [
  ...
  { type: "props-table", heading: "Props", rows: componentProps["SectionNav"] ?? [] },
  {
    ...
    body: [
      {
        kind: "text",
        text: "The full sourced write-up for each of these lives in [Design Heuristics](/docs/heuristics) — this is the compact version, meant to be checked against when touching this component or the `page-index` block that wraps it, not re-derived from the narrative each time.",
      },
      {
        kind: "list",
        items: [
