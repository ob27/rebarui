  ...
  return (
    <Stack gap="lg">
      ...
      <Text color="secondary">
        ...
        for a representative few so far — Button (simple), Dialog (composite, Radix-backed), Form
        (the most complex, with an adapter migration story). The rest are listed here honestly as
        not yet written, not silently skipped.
      </Text>
