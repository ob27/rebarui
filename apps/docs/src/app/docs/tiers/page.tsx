...
const BLOCKS: Block[] = [
  ...
  {
    type: "doc-section",
    heading: "Browse each tier",
    level: 2,
    body: [
      {
        kind: "list",
        items: [
          "[Imitations](/imitations) — 35 components.",
          "[Synthetics](/synthetics) — 44 components, 22 blocks.",
          "[Opinions](/opinions) — 86 components, 9 blocks.",
          "[Orders](/orders) — 8 components, 8 blocks.",
        ],
      },
    ],
  },
