...
const HEURISTIC_BLOCKS: Construct[] = [
  ...
  },
  {
    ...
    rationale: [
      {
        kind: "text",
        text: "Chart components ship with mandatory title, legend, and axis-label slots; they render a visible placeholder when data is absent, never a blank area. If the data can't be shown, the user should know *why* — not wonder whether the chart broke. [/benchmarks](/benchmarks)'s own `ScatterChart`/`LineChart` helpers are a real, shipped example: title and axis labels are required arguments, not optional ones a caller could forget.",
      },
    ],
  },
  {
