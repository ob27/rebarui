...
const BLOCKS: Construct[] = [
  ...
  },
  {
    ...
    body: [
      {
        kind: "text",
        text: "Set `filterable` for a row of toggle buttons below the chart — hiding a series drops its line, its points, and its top-right label. The y-axis scale stays fixed to the full dataset regardless of what's hidden, so a remaining series' own shape never visually distorts as others are toggled. The `line-chart` placement block wraps this same capability rather than reimplementing it — see it live on [/opinions](/opinions#line-chart).",
      },
    ],
  },
  {
