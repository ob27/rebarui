        ...
        blocks={[
          {
            ...
            measured: false,
            description:
              "A drag-and-drop card board — title, optional shared-with avatars, a Share action, a search box, and an optional Board settings button, all above the real Kanban component: arbitrary columns, optional dividers, cards/columns draggable, per-column/per-section card limits. Literal columns/cards seed a local-only board; source/onChange bind the whole board state to real backend reads/writes instead — Kanban's own onChange forwarded straight through.",
        ...
        blocks={[
          {
            ...
            measured: false,
            description:
              "A distribution scatter plot — each series' individual values plotted as a jittered column of points, with a dashed line marking that series' mean. A filter footer toggles series visibility. A literal series array is static; source binds it to live data instead — read-only, since a chart has no meaningful user-initiated write-back.",
        ...
        blocks={[
          {
            ...
            measured: false,
            description:
              "A multi-series line chart over an ordered x-axis — for cumulative cost/measurement comparisons where one series may overtake another partway through (crossoverIndex). Same series-toggle filter footer and live source binding as scatter-chart. xLabels stays literal-only for now.",
        ...
        blocks={[
          {
            ...
            measured: false,
            description:
              "A stacked bar chart — each bar broken into labeled cost/quantity segments, with the bar's own total shown above it. A filter footer toggles one distinct segment label across every bar at once. Same live source binding as the other two chart blocks.",
