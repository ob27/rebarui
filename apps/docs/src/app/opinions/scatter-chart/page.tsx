...
const BLOCKS: Construct[] = [
  ...
  },
  {
    ...
    body: [
      {
        kind: "text",
        text: "`@rebar-ui/placement`'s `scatter-chart` block doesn't just wrap this component 1:1 — a block always makes a real composition decision, not just pass through a canvas. It adds a filter footer below the chart: one toggle button per series, letting a viewer hide/show individual series without touching the underlying data. See it live on [/opinions](/opinions#scatter-chart).",
      },
    ],
  },
  {
