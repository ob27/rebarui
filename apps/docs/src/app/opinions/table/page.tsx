...
const BLOCKS: Block[] = [
  ...
  },
  {
    ...
    body: [
      {
        kind: "text",
        text: "`@rebar-ui/placement`'s `table` block wraps this component with a search box (matches any cell) and named exact-match filters (collapsing past 2 into a \"More filters\" popover) — never a bare 1:1 pass-through. See it live on [/opinions](/opinions#table).",
      },
    ],
  },
  {
