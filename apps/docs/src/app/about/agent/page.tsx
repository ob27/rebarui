import { Construct, BlockRenderer } from "@rebar-ui/placement";

// Import the placement blocks for this page
const placementBlocks: Construct[] = [
  {
    type: "hero",
    title: "Agent.md",
    imageSrc: "/catalogue-heros/designbot.jpeg",
...
export default function AgentPage() {
  return <BlockRenderer blocks={placementBlocks} />;
}
