...
/**
 * Serves the real LLM.MD as a download, straight from packages/core — the same file that ships
 * in the rebar-ui npm tarball — rather than a duplicated static copy under apps/docs/public. Its
 * own route segment can't literally be named "LLM.MD" (Next.js route segments aren't arbitrary
